Feature: G마켓 PDP 트래킹 로그 정합성 검증
  ...
  Scenario: 상품 상세 페이지에서 모듈별 상품 클릭 시 트래킹 로그 검증
    ...
    Examples:
      ...
      | 4448231882 | 함께 보면 좋은 상품이에요     | C1166813           | C1166814            | C1166816         |              |
      | 4448231882 | 이 판매자의 인기상품이에요    | C1166817           | C1166818            | C1166820         | C1166821     |
      | 4448231882 | 함께 구매하면 좋은 상품이에요 | C1166829           |	C1166830            | C1166832         | C1166833     |